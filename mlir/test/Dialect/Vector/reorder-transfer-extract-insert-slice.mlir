...
func.func @sandwiched_transfer_write(%input: tensor<8x8x8x4xf32>, %val0: vector<4xf32>) -> tensor<8x8x8x4xf32> {
...
// CHECK-LABEL: func.func @sandwiched_transfer_write
...
//       CHECK:   return %[[W1]]
func.func @sandwiched_transfer_write(%input: tensor<1x2x2x4xf32>, %val0: vector<4xf32>, %val1: vector<4xf32>) -> tensor<1x2x2x4xf32> {
  %c0 = arith.constant 0 : index
  %c1 = arith.constant 1 : index

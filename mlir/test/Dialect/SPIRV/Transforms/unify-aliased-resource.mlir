...
// CHECK-NOT: @var01s
//     CHECK: spirv.GlobalVariable @var01v_int bind(0, 1) : !spirv.ptr<!spirv.struct<(!spirv.rtarray<vector<4xi32>, stride=16> [0])>, StorageBuffer>

// CHECK-NOT: @var01s

//     CHECK: spirv.func @different_primitive_type(%{{.+}}: i32, %[[VAL0:.+]]: i32)
//     CHECK:   %[[ADDR:.+]] = spirv.mlir.addressof @var01v_int
//     CHECK:   %[[AC:.+]] = spirv.AccessChain %[[ADDR]][%{{.+}}, %{{.+}}, %{{.+}}]
//     CHECK:   %[[VAL1:.+]] = spirv.Load "StorageBuffer" %[[AC]] : i32
//     CHECK:   spirv.Store "StorageBuffer" %[[AC]], %[[VAL0]] : i32
//     CHECK:   spirv.ReturnValue %[[VAL1]] : i32
...
// CHECK-NOT: @var01_f32
// CHECK-NOT: @var01_i64
//     CHECK: spirv.GlobalVariable @var01_v4f32_int bind(0, 1) : !spirv.ptr<!spirv.struct<(!spirv.rtarray<vector<4xi32>, stride=16> [0])>, StorageBuffer>
// CHECK-NOT: @var01_f32
// CHECK-NOT: @var01_i64
...
// CHECK:    %[[ZERO:.+]] = spirv.Constant 0 : i32
// CHECK:    %[[ADDR0:.+]] = spirv.mlir.addressof @var01_v4f32_int
// CHECK:    %[[AC0:.+]] = spirv.AccessChain %[[ADDR0]][%[[ZERO]], %[[IDX]]]
// CHECK:    spirv.Load "StorageBuffer" %[[AC0]] : vector<4xi32>

// CHECK:    %[[ADDR1:.+]] = spirv.mlir.addressof @var01_v4f32_int

//===- SplitPadding.cpp - PadTensorOp Splitting ---------------------------===//
//
...
//===----------------------------------------------------------------------===//
//
// This file implements patterns and passes for creating scf.if ops to wrap
// linalg.pad_tensor ops and handle padding-unncessary and padding-needed cases
// separately.
//
//===----------------------------------------------------------------------===//
...
#define DEBUG_TYPE "mlir-linalg-split-padding"
...
/// Splits a linalg.pad_tensor op by wrapping it in a scf.if op to handle
/// padding-unnecessary and padding-needed cases.
struct SplitPadding final : public OpRewritePattern<linalg::PadTensorOp> {
  using OpRewritePattern::OpRewritePattern;

  LogicalResult matchAndRewrite(linalg::PadTensorOp padOp,
...
void linalg::populateSplitPaddingPatterns(RewritePatternSet &patterns,
